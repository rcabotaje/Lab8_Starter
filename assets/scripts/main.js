  ...
  if('serviceWorker' in navigator){
    window.addEventListener('load', function(){
      ...
      .then(function(registration){
        console.log("It was successful", registration);
      })
      .catch(function(error){
        console.error("it was unsuccessfull", error);
      });
    });
  }
...
async function getRecipes() {
  ...
  const recipiesfromLoc = localStorage.getItem('recipes');
  if(recipiesfromLoc){
    return JSON.parse(recipiesfromLoc);
  }
  /**************************/
  ...
  //            will be in the catch portion. DONE
  ...
  //            function is using the async keyword so we recommend "await" DONE
